...
| **Standing orders (16 non-negotiable rules)** | Nobody | No framework specifies *invariant rules* enforced mechanically. AEGIS has 39 controls. Standing orders are not controls — they're behavioral invariants loaded into every agent's context. |
