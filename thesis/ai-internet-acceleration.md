...
AI is adopting faster than anything before it because it didn't have to build its own distribution infrastructure. It inherited the internet's. Connectivity, cloud compute, digitized knowledge, software-eaten industries, payment rails, app stores, API ecosystems — all of it built over 30 years for internet-era reasons. AI showed up and used all of it without building any of it.

[ChatGPT reached 100M users in two months](https://www.reuters.com/technology/chatgpt-sets-record-fastest-growing-user-base-analyst-note-2023-02-01/). The internet took seven years. [Enterprise AI revenue went from $1.7B to $37B in three years](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise/). That kind of speed is only possible when someone else already solved the distribution problem for you.

We used to frame AI as "the internet's exploitation stage" — like how factory redesign exploited electrification. We dropped that framing. The internet was a communication technology. AI targets cognition. Those are different categories. [AlphaFold predicting 200 million protein structures](https://www.nature.com/articles/s41586-024-07487-w) depends on internet infrastructure, sure, but calling it "internet exploitation" stretches the framework past the point of usefulness. AI without the internet is a brain without a body. But brains aren't the exploitation phase of bodies.

The narrower claim holds up better and is more useful: AI inherits internet distribution infrastructure, and that inheritance explains the speed.
...
**Electricity.** First stage ran from the 1880s to the 1920s: generation, transmission, wiring. Factories kept the same layouts they'd used for steam and just swapped in an electric motor. Modest gains. The real payoff came when factories put individual motors on each machine and redesigned the floor around workflow instead of around a central power source. [Paul David](https://www.jstor.org/stable/2006600) documented about 40 years from the dynamo to the manufacturing productivity revolution. The revolution wasn't electricity. It was the redesign that electricity made possible.
...
**But this pattern is not a law.** Nuclear power had massive infrastructure investment and no exploitation stage. VR has had three infrastructure cycles with nothing to show for it. [Fiber optic cable sat 85-95% unused](https://en.wikipedia.org/wiki/Dot-com_bubble) years after the buildout. The two-stage pattern works for some technologies and fails for others. Whether AI follows electricity or nuclear power is a judgment call, not a certainty.

The strongest argument that AI fits the pattern is that AI is a network technology — its value scales with the data, users, and systems it connects to. Electricity, railroads, the printing press, and the internet are all network technologies, and the two-stage pattern holds for each. But that's a categorization, not proof.

-----

## What the Internet Built, and What AI Got for Free

**1. Universal connectivity.** [5.56 billion internet users](https://datareportal.com/global-digital-overview), 68% of the world. [4.7 billion smartphones](https://www.statista.com/statistics/330695/number-of-smartphone-users-worldwide/). Fiber, cellular, satellite ([Starlink: 10M+ subscribers, ~150 countries](https://www.starlink.com/)). Any person can reach any service instantly. AI inherited all of it.

**2. Digitized knowledge.** The sum of human knowledge is online. [630 million+ GitHub repositories](https://github.blog/news-insights/octoverse/octoverse-2025/). [Hundreds of millions of academic papers](https://www.semanticscholar.org/). [500 hours of video uploaded to YouTube every minute](https://www.youtube.com/about/press/). It was all digitized for internet-era reasons — search, access, sharing. It turned out to be the perfect training substrate for language models.
...
**4. Cloud-scale compute.** AI inherits the internet's distribution network — connectivity, CDNs, APIs, app stores, payment rails, user bases — while building its own compute layer on top. [$660-690 billion in 2026 hyperscaler capex](https://futurumgroup.com/insights/ai-capex-2026-the-690b-infrastructure-sprint/) is going to AI-specific infrastructure. [Data center vacancy is at a record-low 1.6%](https://www.cbre.com/insights/reports/us-data-center-trends-2025). The distribution infrastructure — the part that historically takes decades and costs trillions — was already done. The compute infrastructure just takes money, and the [most profitable companies in history](https://futurumgroup.com/insights/ai-capex-2026-the-690b-infrastructure-sprint/) are spending it.

**5. Payment and identity rails.** Digital payments, authentication, subscription billing — the commercial plumbing required to monetize AI was built by the internet economy. [Stripe processes $1.9 trillion annually](https://stripe.com/newsroom).
...
If you think AI is a new revolution starting from scratch, you'll make three specific mistakes.

**You'll overestimate the infrastructure required.** The distribution infrastructure is done. AI doesn't need its own connectivity or platforms or distribution channels — it uses the internet's. This is why adoption is faster than anything we've seen.

[Anthropic's ARR](https://www.anthropic.com/) went from $1B (Dec 2024) to $14B+ (Feb 2026). 14x in 14 months. Fastest B2B software scaling in history. [Cursor reached $1B+ ARR](https://www.cursor.com/) with 360K+ paying users in under two years. This kind of growth is only possible because the go-to-market infrastructure was already there.

**You'll misidentify the competition.** The competitive landscape isn't AI startup vs. AI startup. It's AI-accelerated company vs. pre-AI company. The [$285B SaaSpocalypse](https://markets.financialcontent.com/stocks/article/marketminute-2026-2-6-anthropics-claude-cowork-release-triggers-285-billion-saaspocalypse-a-brutal-wake-up-call-for-legacy-tech-and-finance) made this obvious. The companies that lost value were pre-AI incumbents: Thomson Reuters (-16%), Salesforce (-26% YTD), LegalZoom (-20%), ServiceNow (-7.6%), Intuit (-11%). Not AI vs. AI. AI capability vs. no AI capability.

**You'll misallocate resources.** The highest-ROI AI investments are AI applied to internet-era businesses that already have distribution, revenue, and users — not greenfield AI products built from scratch. [Microsoft/IDC research](https://blogs.microsoft.com/blog/2024/11/12/new-agentic-ai-idc-report/) finds top performers get $10.30 in value per $1 invested in generative AI vs. $3.70 average. [IBM's enterprise AI deployments](https://www.cio.com/article/3968783/ibm-agent-ai-in-direct-use-delivers-3-5-billion-in-productivity-impact.html) generated an estimated $3.5B in savings by augmenting existing workflows. [Shopify's Sidekick](https://www.shopify.com/) gained write access to production infrastructure with ~70% internal Copilot adoption. AI applied to an existing platform, not AI building one from nothing.

The internet era taught us that most incumbents move too slowly. The winners weren't pre-internet companies that "adopted the internet." They were companies built on the internet from day one. The same pattern is likely playing out here.
...
Partly. We cited electricity, railroads, and the printing press. We didn't cite nuclear power, VR, or fiber optics. The pattern works for some technologies and not others. What we can say with confidence: AI inherits internet distribution infrastructure, and that inheritance explains the speed. Whether the two-stage framework is the right lens is less certain than we used to claim.
...
If the historical patterns hold, full economic impact likely arrives in the 2030-2040 range — not 2027.

The internet was the infrastructure. AI is the intelligence. The combination is what everyone has been promising for decades. The delivery will take longer than people are saying.
