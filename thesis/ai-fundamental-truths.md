...
GPT-4 came out in March 2023. It couldn't reliably write a working web app. Three years later, Claude Code and Codex agents generate production-grade applications with test suites. A growing share of code written globally is now AI-generated or AI-assisted [Source: UNVERIFIED — widely cited "41% of all code globally" figure is not found in the GitHub Octoverse 2025 report as linked; it originated from narrower 2022–2023 GitHub Copilot product data measuring AI-suggested code in Copilot-enabled files, not all code globally; see [GitHub Octoverse 2025](https://github.blog/news-insights/octoverse/octoverse-2025/)]. [51% of professional developers use AI coding tools daily](https://survey.stackoverflow.co/2025/) [Source: Stack Overflow, "Developer Survey 2025", December 2025; note: the widely cited 92% figure is from a March 2023 GitHub/Wakefield survey of 500 enterprise developers measuring any usage, not daily use by the broader developer population]. SWE-Bench Verified scores went from 0% to [80.8% for Claude Opus 4.6](https://www.anthropic.com/claude) in under three years [Source: SWE-Bench leaderboard, swebench.com, accessed March 2026]. GPT-5.4 surpassed human performance on OSWorld ([75.0% vs. 72.4% human baseline](https://openai.com/index/gpt-5-4/)). DeepSeek won [gold medals at the International Mathematical Olympiad and International Olympiad in Informatics](https://arxiv.org/abs/2501.12948).
...
In January 2025, everyone agreed that training a frontier model required hundreds of millions of dollars. Three weeks later, [DeepSeek's R1](https://www.npr.org/2025/01/27/nx-s1-5276097/wall-street-stock-markets-tumble-deepseek-ai-tech-stock), whose final training run cost a reported $5.6M [Source: DeepSeek; note: this figure covers only the compute cost of the final V3 training run; total development cost including hardware, prior runs, and R&D is estimated well above $500M per SemiAnalysis], matched models costing 50x more and triggered a $1 trillion single-day market wipeout [Source: Yahoo Finance / Fortune, January 27, 2025; confirmed for U.S. tech sector]. In February 2026, the consensus was that enterprise SaaS would adapt gradually. Then Anthropic released enterprise plugins for [Claude Cowork](https://markets.financialcontent.com/stocks/article/marketminute-2026-2-6-anthropics-claude-cowork-release-triggers-285-billion-saaspocalypse-a-brutal-wake-up-call-for-legacy-tech-and-finance) [Source: Anthropic; note: Claude Cowork launched January 12–13, 2026; the February 3 event was the release of 11 enterprise plugins that triggered the market selloff; see [Bloomberg, Feb 3, 2026](https://www.bloomberg.com/news/articles/2026-02-03/legal-software-stocks-plunge-as-anthropic-releases-new-ai-tool)] and erased $285 billion in market cap in one session [Source: Bloomberg, February 3, 2026]. In the first two weeks of March 2026, [12+ frontier models shipped in a single week](https://openai.com/blog), JetBrains launched an AI-native IDE, and the coding-agent landscape reshuffled entirely.
...
McKinsey's 2025 State of AI survey found that top-performing companies capture significantly higher returns from AI than average — though McKinsey's report frames this in terms of EBIT impact rather than a dollar-per-dollar figure [Source: McKinsey, "The State of AI", November 2025; note: the widely cited "$10.30 per $1 invested vs. $3.70 average" figures could not be verified against the McKinsey report as linked; McKinsey defines top performers as companies attributing 5%+ of EBIT to AI; see [McKinsey State of AI 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai)]. These companies didn't have the best AI. They had leadership that identified the right problems to apply AI to.
...
McKinsey's State of AI research backs this up: the gap between top AI performers and average companies comes down entirely to problem selection [Source: McKinsey, "The State of AI", November 2025; note: "$10.30 per $1 vs. $3.70" figures could not be verified in this report; McKinsey measures via EBIT impact; see [McKinsey](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai)]. [Sectors with high AI exposure show 3x higher revenue growth per worker](https://openai.com/index/the-state-of-enterprise-ai-2025-report/), but only when the AI is pointed at the right problems.
...
- [GitHub Octoverse 2025](https://github.blog/news-insights/octoverse/octoverse-2025/) — note: widely cited "41% of all code is AI-generated" figure is not in this report; see inline correction
- [Stack Overflow Developer Survey 2025 — 51% of professional developers use AI tools daily](https://survey.stackoverflow.co/2025/) — note: the "92%" figure is from a 2023 GitHub/Wakefield enterprise survey (any usage, 500 respondents), not this report
...
- [McKinsey — State of AI 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) — note: "$10.30 per $1 vs. $3.70" ROI figures not verified in this report; McKinsey measures top performers via EBIT impact (5%+ of EBIT attributed to AI)
- [OpenAI — Enterprise AI 2025 report](https://openai.com/index/the-state-of-enterprise-ai-2025-report/)
- [BCG — AI agents in healthcare](https://www.bcg.com/publications/2026/how-ai-agents-will-transform-health-care) — note: lung nodule detection figures (94% AI vs. 65% radiologists) originate from MGH/MIT research cited by BCG, not BCG's own analysis
