...
import { TaskDecomposer, type Subtask, type DecompositionResult } from "./decomposition";
import { RoutingEngine } from "./engine";

// Minimal routing config that resolves task types to agents
const routingEngine = new RoutingEngine({
  rules: [
    { taskType: "code", primaryAgent: "coder", fallbackAgent: "admiral", escalationTarget: "admiral", constraints: [] },
    { taskType: "review", primaryAgent: "reviewer", fallbackAgent: "admiral", escalationTarget: "admiral", constraints: [] },
    { taskType: "design", primaryAgent: "architect", fallbackAgent: "admiral", escalationTarget: "admiral", constraints: [] },
    { taskType: "test", primaryAgent: "tester", fallbackAgent: "admiral", escalationTarget: "admiral", constraints: [] },
  ],
  fileOwnership: [],
  capabilities: [],
});
  ...
  describe("validateDecomposition", () => {
    ...
    it("detects unknown dependency", () => {
      const result: DecompositionResult = {
        originalTask: "test",
        subtasks: [
          { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 100, dependencies: ["missing"], order: 0 },
        ],
        totalBudget: 100,
        warnings: [],
      };
    ...
    it("detects circular dependencies", () => {
      const result: DecompositionResult = {
        originalTask: "test",
        subtasks: [
          { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 50, dependencies: ["s2"], order: 0 },
          { id: "s2", description: "b", agentId: "y", acceptanceCriteria: [], budgetTokens: 50, dependencies: ["s1"], order: 1 },
        ],
        totalBudget: 100,
        warnings: [],
      };
    ...
    it("detects budget overrun", () => {
      const result: DecompositionResult = {
        originalTask: "test",
        subtasks: [
          { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 600, dependencies: [], order: 0 },
          { id: "s2", description: "b", agentId: "y", acceptanceCriteria: [], budgetTokens: 600, dependencies: [], order: 1 },
        ],
        totalBudget: 1000,
        warnings: [],
      };
  ...
  describe("detectArtificialSplit", () => {
    it("returns false for single subtask", () => {
      const subtasks: Subtask[] = [
        { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 100, dependencies: [], order: 0 },
      ];
    ...
    it("returns true when all subtasks share an agent", () => {
      const subtasks: Subtask[] = [
        { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 50, dependencies: [], order: 0 },
        { id: "s2", description: "b", agentId: "x", acceptanceCriteria: [], budgetTokens: 50, dependencies: [], order: 1 },
      ];
    ...
    it("returns false when subtasks have different agents", () => {
      const subtasks: Subtask[] = [
        { id: "s1", description: "a", agentId: "x", acceptanceCriteria: [], budgetTokens: 50, dependencies: [], order: 0 },
        { id: "s2", description: "b", agentId: "y", acceptanceCriteria: [], budgetTokens: 50, dependencies: [], order: 1 },
      ];
      assert.equal(decomposer.detectArtificialSplit(subtasks), false);
    });
  });
