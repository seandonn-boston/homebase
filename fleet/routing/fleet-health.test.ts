...
import { FleetHealthMonitor, type AgentHealthMetrics } from "./fleet-health";
...
describe("FleetHealthMonitor", () => {
  ...
  describe("getSummary", () => {
    ...
    it("computes aggregate metrics", () => {
      monitor.updateMetrics("a", { utilization: 40, errorRate: 10, throughput: 5, budgetBurn: 100 });
      monitor.updateMetrics("b", { utilization: 60, errorRate: 20, throughput: 10, budgetBurn: 200 });
