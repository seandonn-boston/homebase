...
describe("TrustStore", () => {
  ...
  beforeEach(() => {
    store = new TrustStore({ minConsecutiveSuccesses: 3, minDecisionsForPromotion: 3 });
  });
  ...
  describe("serialization", () => {
    it("round-trips through serialize/deserialize", () => {
      ...
      assert.equal(restoredRecord.consecutiveSuccesses, original.consecutiveSuccesses);
