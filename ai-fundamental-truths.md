...
**AI capabilities are improving on a trajectory with no confirmed ceiling, but the rate of improvement may slow, and the timeline for organizations to actually capture any of this is measured in decades.**

The trend is real. Every six months the thing that was impossible becomes a demo, and the thing that was a demo becomes a commodity. If you are making plans based on what AI cannot do today, the ground is moving under you.
