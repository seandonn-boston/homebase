...
**What we actually believe, after arguing with ourselves.**
...
We wrote three thesis documents about AI: one about what it does to human skills, one about its relationship to the internet, and one about whether the investment cycle is a bubble. Each was directionally correct. Each was also too certain, too neat, and too willing to dismiss counterevidence with rhetorical moves instead of engaging with it honestly.

This document is the corrective. It states what we believe, what we're uncertain about, and what would change our minds — without the sensationalism, the cherry-picked case studies, or the false confidence that makes thesis documents read well and age poorly.

---

## Thesis 1: AI and Human Skills

### What we believe

The economic value of pure execution — writing code, producing copy, generating designs, conducting routine analysis — is declining. AI does not need to be better than the best human practitioner to change the economics. It needs to be good enough and cheap enough that the premium for execution compresses. That threshold has been crossed in software engineering ([41% of code is now AI-generated](https://github.blog/news-insights/octoverse/octoverse-2025/), [92% of U.S. developers use AI tools daily](https://survey.stackoverflow.co/2025/)), and is being crossed in legal research, content production, and data analysis.
...
AI adoption is fast because it inherits internet infrastructure. Whether AI is "stage two of the internet" or something categorically new is an open question we previously answered too confidently. The strategic advice — build AI-accelerated internet companies, not pure AI companies — holds either way. Full economic impact arrives around 2035, not 2027.

---

## Thesis 3: AI Investment

### What we believe

This is not a bubble in the structural sense.

**The fundamentals are different from dotcom.** Mag 7 at ~28x expected earnings vs. ~60x+ at dotcom peak. Nvidia P/E 44–47x vs. Cisco's 472x. Big 5 generated [$400B+ in trailing FCF](https://www.goldmansachs.com/insights/articles/why-ai-companies-may-invest-more-than-500-billion-in-2026). Funded from cash flow, not debt and IPOs.

**The fourth horseman is missing.** [Owen Lamont's bubble-detection framework](https://fortune.com/2026/02/01/is-ai-a-bubble-top-economist-says-no-because-ipos-fraud/) requires overvaluation, bubble beliefs, share issuance, and inflows. Public equity issuance is absent — ~$1 trillion in buybacks means share supply is shrinking. Structurally different from every prior bubble. Watch OpenAI's Q4 2026 IPO; if it triggers a wave, this changes.

**The technology works.** The [$285B SaaSpocalypse](https://markets.financialcontent.com/stocks/article/marketminute-2026-2-6-anthropics-claude-cowork-release-triggers-285-billion-saaspocalypse-a-brutal-wake-up-call-for-legacy-tech-and-finance) was caused by AI succeeding, not failing. Bubbles are characterized by technology that doesn't deliver. This technology threatened $2+ trillion in incumbent market cap because it delivered.
...
Not a bubble. A legitimate infrastructure buildout funded by the most profitable companies in history, deploying technology that demonstrably works. The down payment is 5–10 years ahead of the revenue that justifies it, not 3–5. "The technology works" is proven. "The investment returns will justify this scale on this timeline" is a bet. We are making the bet. We know it is a bet.

---

## Across All Three: Errors We Are Correcting

**Cherry-picking.** Spotify, Cursor, and Anthropic are leading indicators from AI-native domains. They are not proof of where median knowledge workers are headed. We cited them as the latter. That was wrong.

**Analogy as dismissal.** We invoked the Solow paradox to dismiss productivity data and AWS to dismiss the revenue gap. Both analogies actually undermine the fast timeline: Solow implies 30 years, AWS involved demand-proven infrastructure. Using them as bull-case shields was intellectually dishonest.

**Direction without timeline.** "This happens by 2028" and "this happens by 2040" are different theses with different implications for career decisions, investment horizons, and company strategy. We conflated them.

**Marketing confidence.** "The value of doing things has collapsed." "The revolution is finishing." "The returns are coming." These are slogans, not analysis.

---

## Summary

**Skills:** Execution value declining. Judgment value rising. Timeline: decades, not years. Benchmark capability ≠ organizational capture.

**Internet:** AI is fast because it inherits internet infrastructure. Build on existing distribution, not from scratch.

**Investment:** Not a bubble. Good long-term bet. Timeline is longer than the market expects. Revenue gap is real. The builders can afford patience. The question is whether their investors can.

**Across all three:** Direction is clear. Timeline is not. This is a 2035 story, not a 2027 story. Move decisively on direction. Build tolerance for timeline uncertainty.
...
- [Wikipedia — Dot-com bubble / dark fiber](https://en.wikipedia.org/wiki/Dot-com_bubble)

### Investment & Valuation
- [Owen Lamont bubble-detection framework (Fortune)](https://fortune.com/2026/02/01/is-ai-a-bubble-top-economist-says-no-because-ipos-fraud/)
- [Sequoia Capital — AI's $600B Question](https://www.sequoiacap.com/article/ais-600b-question/)
- [Goldman Sachs — AI capex projections](https://www.goldmansachs.com/insights/articles/why-ai-companies-may-invest-more-than-500-billion-in-2026)
...
- [Robert Gordon / NBER — Is U.S. Economic Growth Over?](https://www.nber.org/papers/w18315)
