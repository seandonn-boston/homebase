...
> **Last updated:** 2026-03-16 | **Spec version:** v0.17.1-alpha | **Control plane:** v0.6.0-alpha
...
| 8 | Platform Integration | Partial | `.hooks/`, `.claude/settings.local.json` | Claude Code hooks implemented; no other platform adapters |
