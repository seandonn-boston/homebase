...
- **The meta-agent cannot unilaterally approve new MCP servers or A2A connections.** Protocol changes require the Server Addition Checklist ([Part 13](part13-mcp-integration.md) Section 2) and A2A testing ([Part 13](part13-mcp-integration.md) Section 5) review. These are configuration changes that require human approval.
