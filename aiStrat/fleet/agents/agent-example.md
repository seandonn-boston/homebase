...
- **Human review triggers:** {When must this agent recommend human review? e.g., "When security implications exceed LLM analysis capability", "When architectural decisions have multi-year consequences". Reference [Human Referral Protocol](../../admiral/part11-protocols.md) for the full Human Referral Protocol.}
