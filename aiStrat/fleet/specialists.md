...
The full protocol for human referral is defined in [admiral/part11-protocols.md, Human Referral Protocol](../admiral/part11-protocols.md).
...
5. **Know when to call a human.** This is your highest-value judgment. See [admiral/part11-protocols.md, Human Referral Protocol](../admiral/part11-protocols.md).
